...
对于二分的应用，在具体的算法问题中，常用到的是搜索左侧边界和搜索右侧边界这两种场景，很少有让你单独搜索一个元素。因为算法题一般都是让你求最值，求最值的过程，必然是搜索一个边界的过程。

---

举个例子，比如两个经典排序算法 [快速排序](https://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247496139&idx=1&sn=b0aca0f2b98e23495c9bd13bb4d90e40&scene=21#wechat_redirect) 和 [归并排序](https://mp.weixin.qq.com/s?__biz=MzAxODQxMDM0Mw==&mid=2247495989&idx=1&sn=30e34ac75dd1c724205e9c8b0f488e35&scene=21#wechat_redirect)，对于它俩，你有什么理解？
...
「使……最大值尽可能小」是二分搜索题目常见的问法。「将数组分割为 m*m* 段，求……」是动态规划题目常见的问法。
...
![image-20221130163637100](Leetcode.assets/image-20221130163637100.png)

https://blog.csdn.net/weixin_42989041/article/details/113183015
